...
- How to ensure a Multi-Agent System is safe and reliable?
...
## <span class="underline-accent">What is <span class="emphasis-danger">not</span> an Agentic AI?</span>

<div class="pt-8">

A Non-Agentic AI is a process where an LLM-based application executes <span class="emphasis-accent">a single step</span> to complete a task.
...
<span class="callout__label">EXAMPLE PROMPT (ZERO-SHOT)</span>

Please write an essay on topic X.

</blockquote>

<div class="pt-8">

<img src="assets/images/llm.png" alt="LLM Flow" style="max-height: min(70vh, 900px);" />
...
## <span class="underline-accent"><span class="emphasis-success">Now</span>, what is an Agentic AI?</span>

<div class="pt-6">

An Agentic AI is a process where an LLM-based application executes <span class="emphasis-accent">multiple steps</span> to complete a task.
...
<img src="assets/images/agentic-workflow.png" alt="LLM Flow" style="max-height: min(70vh, 900px);" />
...
## <span class="underline-accent">What is an AI Agent?</span>

<div>

<img src="assets/images/agent-steps.png" alt="Agent Steps" style="max-height: min(70vh, 900px);" />
...
An AI Agent has a few major components:

- <span class="emphasis-success">LLM</span> - The Brain

- <span class="emphasis-info">Tools</span> - The Hands

- <span class="emphasis-warning">Orchestration Layer</span> - The Mind

- <span class="emphasis-other">Context</span>

<div class="fragment pt-8">

It uses an <span class="emphasis-success">LLM</span> to reason, <span class="emphasis-info">tools</span> to interact with the external environment, the <span class="emphasis-warning">orchestration layer</span> to manage the iterative decision-making process, and <span class="emphasis-other">context</span> to maintain state and memory across iterations, to achieve autonomous task completion.
...
<img src="assets/images/ai-agent.png" alt="Agent Flow" style="max-height: min(70vh, 900px);" />
...
A software system that uses <span class="emphasis-accent">one or more AI agents</span> to perform tasks <span class="emphasis-accent">autonomously</span>.
...
Prompt: "Write me a joke about AI that a non-technical person can understand."
...
Connects LLMs to the <span class="emphasis-accent">external environment</span> via tools.
...
<img src="assets/images/level-2-example.png" alt="Agentic System Pyramid" style="max-height: min(70vh, 900px);" />
...
<span class="italic text-sm">(More about this in a bit.)</span>
...
At this level, agents can <span class="emphasis-success">self-evolve</span> without <span class="emphasis-danger">human intervention</span> at the <span class="emphasis-info">architecture level</span>.

<div class="pt-6">

<span class="underline-accent">Example:</span> Google Co-Scientist is closer to such a system.
...
<img src="assets/images/multi-agent.png" alt="Multi-Agent System Architecture" style="max-height: min(50vh, 550px);" />
...
<img src="assets/images/multi-agent-guardrails.png" alt="Multi-Agent System with Guardrails" style="max-height: min(70vh, 900px);" />
...
Note: Such agents evaluate response <span class="highlight-success">quality, relevance, and tone</span>. They complement <span class="emphasis-success">guardrails</span>, which focus on preventing harmful outputs and enforcing hard constraints.
...
<img src="assets/images/keyfinz.png" alt="KeyFinz AI Assistant Architecture" style="max-height: min(70vh, 900px);" />
...
- <span class="emphasis-accent">Agentic AI</span> executes <span class="emphasis-success">multiple steps</span> through iterative loops; <span class="emphasis-danger">Non-Agentic AI</span> executes <span class="emphasis-info">a single step</span>

- An <span class="emphasis-accent">AI Agent</span> requires <span class="emphasis-success">LLM</span>, <span class="emphasis-info">Tools</span>, <span class="emphasis-warning">Orchestration Layer</span>, and <span class="emphasis-other">Context</span>

- <span class="emphasis-accent">Levels of Agentic Systems</span> range from <span class="emphasis-success">LLM-only</span> (Level 0) to <span class="emphasis-info">self-evolving agents</span> (Level 4)

- <span class="emphasis-accent">Multi-Agent Systems</span> improve <span class="emphasis-success">cost, accuracy, reliability, and maintainability</span> through specialized sub-agents

- Safety requires <span class="emphasis-accent">guardrails</span>

- Test for <span class="emphasis-accent">acceptability</span>, not exactness
